    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homework3_app.customer')),
                ('products', models.ManyToManyField(to='homework3_app.product')),
            ],
        ),
    ]
